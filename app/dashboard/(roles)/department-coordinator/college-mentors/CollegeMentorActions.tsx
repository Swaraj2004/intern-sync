...
type CollegeMentorActionsProps = {
  onDelete: () => Promise<void>;
  onSendInvite: () => Promise<void>;
  isVerified: boolean;
};

export const CollegeMentorActions: React.FC<CollegeMentorActionsProps> = ({
  onDelete,
  onSendInvite,
  isVerified,
}) => {
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will send an invite email to the college mentor.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
