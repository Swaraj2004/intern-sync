  ...
  public: {
    ...
    Functions: {
      ...
      approve_student_attendance_requests: {
        Args: { request_id: string; mentor_approval: boolean }
        Returns: undefined
      }
      change_college_mentor: {
        Args: { student_id: string; new_college_mentor_id: string }
        Returns: undefined
      }
      check_holiday_for_student: {
        Args: { student_id: string; internship_id: string; check_date: string }
        Returns: boolean
      }
      ...
      get_students_attendance_for_company_mentor: {
        Args: { company_mentor_id: string; attendance_date: string }
        Returns: {
          student_uid: string
          user_name: string
          company_mentor_uid: string
      ...
      get_students_reports_for_company_mentor: {
        Args: { company_mentor_id: string; report_date: string }
        Returns: {
          student_uid: string
          user_name: string
          company_mentor_uid: string
      ...
      get_total_present_days: {
        Args: { student_id: string; internship_id: string }
        Returns: number
      }
